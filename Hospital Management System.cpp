...
int main ()
{
	...
	while(choice!=5)
	{
		strcpy(departments[0].departmentname,"General Department\n");
		strcpy(departments[1].departmentname,"Urology Department\n");
		strcpy(departments[2].departmentname,"Neurology Department\n");
		strcpy(departments[3].departmentname,"Cardiology Department\n");
		system("cls");
